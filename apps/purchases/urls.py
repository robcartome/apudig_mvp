...
urlpatterns = [
    ...
    path("documents/api/receipt-movements/", views.purchase_receipt_movements_api, name="receipt_movements_api"),
    ...
    path("documents/<uuid:pk>/receipts/reconcile/", views.purchase_document_reconcile_receipts, name="document_reconcile_receipts"),
