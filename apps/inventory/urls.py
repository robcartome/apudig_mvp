...
from .views import (
    ...
    pricelist_list, pricelist_set_default, pricelist_toggle, pricelist_update,
...
urlpatterns = [
    ...
    path("price-lists/<uuid:pk>/set-default/", pricelist_set_default, name="pricelist_set_default"),
